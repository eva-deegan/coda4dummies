...
#' @param just_chain_number if set to True, will just return the lowest deviance chain number, not the initials
...
#' @export
savelowdev <- function(codaobj, to_keep, paramlist, type, just_chain_number=F){
